use powdr_ast::parsed::asm::{
    ASMModule, ASMProgram, FunctionStatement, Instruction, InstructionBody, Machine,
...
use powdr_ast::parsed::{
    ...
    SourceReference, StatementInsideBlock,
};
...
impl ClearSourceRefs for Expression {
    fn clear_source_refs(&mut self) {
...
impl ClearSourceRefs for MatchExpression {
    fn clear_source_refs(&mut self) {
...
impl ClearSourceRefs for LambdaExpression {
    fn clear_source_refs(&mut self) {
        self.params
            .iter_mut()
            .for_each(ClearSourceRefs::clear_source_refs)
