...
/// Takes a map with the original definitions of bus interaction variables and a
/// list of variable assignments and returns an equivalent list substituting the
/// bus interaction variables by their original definition.
...
{
    let mut result = Vec::<Substitution<T, V>>::new();
