...
use openvm_circuit::arch::{
    ...
    PreflightExecutionOutput, RowMajorMatrixArena, SystemConfig, VirtualMachine, VmBuilder,
    VmChipComplex, VmCircuitConfig, VmCircuitExtension, VmExecutionConfig, VmInstance,
    VmProverExtension,
};
...
use powdr_autoprecompiles::{execution_profile::execution_profile, JsonExport, PowdrConfig};
