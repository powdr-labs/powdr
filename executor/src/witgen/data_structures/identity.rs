...
namespace main(4);
    ...
    col witness left_latch, a, b, multiplicities;
    {constraint}
...
"
    ...
    fn native_lookup() {
        assert_correct_bus_interaction_pair(
            ...
            "BusSend(tuple=main::left_latch $ [4, main::a], multiplicity=main::left_latch)",
            "BusReceive(tuple=main::right_latch $ [4, main::b], multiplicity=None)",
            true,
        );
    }
    ...
    fn phantom_lookup() {
        assert_correct_bus_interaction_pair(
            ...
            "BusSend(tuple=main::left_latch $ [4, main::a], multiplicity=main::left_latch)",
            "BusReceive(tuple=main::right_latch $ [4, main::b], multiplicity=main::multiplicities)",
            true,
        );
    }
