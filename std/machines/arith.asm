    ...
    call_selectors: sel,
{
    ...
    // TODO: Make this work even though reads and writes are different.
    ...
    *******/
    ...
    link if do_mload ~> output_mload = mem.mload(addr_mload, time_step);
    ...
    link if do_mstore ~> mem.mstore(addr_mstore, time_step, value_mstore);
