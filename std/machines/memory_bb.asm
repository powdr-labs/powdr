    ...
    call_selectors: selectors,
{
    ...
    operation mload<0> m_addr1, m_addr2, m_step -> m_value1, m_value2;
    operation mstore<1> m_addr1, m_addr2, m_step, m_value1, m_value2 ->;
    ...
    // this machine...
    col witness m_addr1, m_addr2;
    col witness m_step;
    col witness m_change;
    col witness m_value1, m_value2;

    link => byte2.check(m_addr1);
    link => byte2.check(m_addr2);
    ...
    (m_addr1' - m_addr1) * (1 - m_change) = 0;
    (m_addr2' - m_addr2) * (1 - m_change) = 0;
    ...
    // TODO check this
    col diff = (m_change * ((m_addr1' - m_addr1)  + (m_addr2' - m_addr2) * 2**16) + (1 - m_change) * (m_step' - m_step));
