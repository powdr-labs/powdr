...
mod single_instruction_tests {
    ...
    fn single_add_0() {
        ...
        let machine = compile(program.to_vec());
...
is_valid * (is_valid - 1) = 0
    "#.trim();
        assert_eq!(expected.trim(), machine);
    }
...
mult=is_valid * 1, args=[2, mem_ptr_limbs__0_0 + 65536 * mem_ptr_limbs__1_0, read_data__0_0, write_data__1_0, write_data__2_0, write_data__3_0, write_base_aux__prev_timestamp_0 + write_base_aux__timestamp_lt_aux__lower_decomp__0_0 + 131072 * write_base_aux__timestamp_lt_aux__lower_decomp__1_0]
mult=is_valid * -1, args=[1, 8, prev_data__0_0, prev_data__1_0, prev_data__2_0, prev_data__3_0, write_base_aux__prev_timestamp_0]
mult=is_valid * 1, args=[1, 8, read_data__0_0, write_data__1_0, write_data__2_0, write_data__3_0, write_base_aux__prev_timestamp_0 + write_base_aux__timestamp_lt_aux__lower_decomp__0_0 + 131072 * write_base_aux__timestamp_lt_aux__lower_decomp__1_0 + 1]
...
is_valid * (is_valid - 1) = 0
    "#;
        assert_eq!(expected.trim(), machine.to_string());
    }
