...
pub struct GlobalConstraints<'a, T: FieldElement> {
    pub known_witness_constraints: ColumnMap<Option<RangeConstraint<T>>, Committed>,
...
pub fn determine_global_constraints<'a, T: FieldElement>(
    ...
    let mut known_witness_constraints: ColumnMap<Option<RangeConstraint<T>>, Committed> =
