...
fn test_linearizer() {
    ...
    let algebraic_constraints = vec![
        ...
        v("rs2_ptr_0") - c(0),
        v("imm_0") - c(8),
        c(1) - v("BusInteractionField(0, 1)"),
        c(1) - v("BusInteractionField(1, 1)"),
        -(c(1) + v("BusInteractionField(2, 1)")),
        c(1) - v("BusInteractionField(3, 1)"),
        c(1) - v("BusInteractionField(4, 1)"),
        c(1) - v("BusInteractionField(5, 1)"),
        -(c(1) + v("BusInteractionField(6, 1)")),
        c(1) - v("BusInteractionField(7, 1)"),
        c(1) - v("BusInteractionField(8, 1)"),
        -(c(1) + v("BusInteractionField(9, 1)")),
        c(1) - v("BusInteractionField(10, 1)"),
