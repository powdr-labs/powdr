...
pub fn execute_ast<F: FieldElement>(
    ...
    match F::known_field() {
        Some(KnownField::BabyBearField | KnownField::Mersenne31Field) => executor_16::execute_ast(
            program,
            initial_memory,
            inputs,
            bootloader_inputs,
        ...
        Some(KnownField::GoldilocksField | KnownField::Bn254Field) => executor_32::execute_ast(
            program,
            initial_memory,
            inputs,
            bootloader_inputs,
