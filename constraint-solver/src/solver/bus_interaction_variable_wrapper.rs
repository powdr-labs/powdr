...
fn unwrap_expression<T, V>(
    ...
    mut expr: GroupedExpression<T, Variable<V>>,
) -> GroupedExpression<<T::Transformed as VarTransformable<Variable<V>, V>>::Transformed, V>
where
    T: RuntimeConstant
        + Substitutable<V>
        + Substitutable<Variable<V>>
        + VarTransformable<Variable<V>, V>
        + VarTransformable<V, Variable<V>>
        + Display,
    <T::Transformed as VarTransformable<Variable<V>, V>>::Transformed: RuntimeConstant,
    V: Ord + Clone + Hash + Eq,
{
