...
pub mod prelude {
    ...
    pub use super::{
        default_openvm_bus_map, ALL_OPCODES, DEFAULT_BITWISE_LOOKUP, DEFAULT_EXECUTION_BRIDGE,
        DEFAULT_MEMORY, DEFAULT_PC_LOOKUP, DEFAULT_TUPLE_RANGE_CHECKER,
        DEFAULT_VARIABLE_RANGE_CHECKER, OPCODE_ADD, OPCODE_AND, OPCODE_AUIPC, OPCODE_BEQ,
        OPCODE_BGE, OPCODE_BGEU, OPCODE_BLT, OPCODE_BLTU, OPCODE_BNE, OPCODE_DIV, OPCODE_DIVU,
        OPCODE_HINT_BUFFER, OPCODE_HINT_STOREW, OPCODE_JAL, OPCODE_JALR, OPCODE_LOADB,
        OPCODE_LOADBU, OPCODE_LOADH, OPCODE_LOADHU, OPCODE_LOADW, OPCODE_LUI, OPCODE_MUL,
        OPCODE_MULH, OPCODE_MULHSU, OPCODE_MULHU, OPCODE_OR, OPCODE_REM, OPCODE_REMU, OPCODE_SLL,
        OPCODE_SLT, OPCODE_SLTU, OPCODE_SRA, OPCODE_SRL, OPCODE_STOREB, OPCODE_STOREH,
        OPCODE_STOREW, OPCODE_SUB, OPCODE_XOR,
    };
}
