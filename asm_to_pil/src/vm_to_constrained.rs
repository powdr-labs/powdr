                ...
                .filter_map(|(name, reg)| {
                    reg.update_expression().map(|rhs| {
                        ...
                        match reg.ty {
                            ...
                            Pc => {
                                // introduce XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXx
                                // :wan intermediate witness polynomial to keep the degree of polynomial identities at 2
